...
`@stdout-design/core/og` provides `createOgResponse` — the render bridge for OG images. `@stdout-design/templates` provides the `StandardOgTemplate` component with your product's design tokens baked in.
