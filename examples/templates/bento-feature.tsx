...
export default function BentoFeature({ headline, description, image, tags, background }: Props) {
  return (
    <div
    ...
    >
      <div tw="flex flex-col justify-between flex-1 pr-8">
        ...
        <div>
          ...
          {description ? (
            <p tw="text-lg text-gray-400 leading-relaxed max-w-md">{description}</p>
          ) : null}
        </div>
      </div>
      <div tw="flex-1">
